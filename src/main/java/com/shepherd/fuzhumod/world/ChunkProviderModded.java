...
public class ChunkProviderModded implements IChunkProvider{
	...
	/**
	 * Determines whether something other than nettherack can be generated
	 * at a location
	 */
	...
	/**
	 * Holds the noise used to determine whether slowsand can be generated
	 * at a location
	 */
	private double[] slowsandNoise = new double[256];
	private double[] gravelNoise = new double[256];
	/**
	 * Holds the noise used to determine whether something other than
	 * netherrack can be generated at a location
	 */
	...
	/**
	 * generates a subset of the level's terrain data. Takes 7 arguments:
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		/*
		 * if (doGen && this.hellRNG.nextInt(1) == 0) { j1 = k +
		 * this.hellRNG.nextInt(16) + 8; k1 = this.hellRNG.nextInt(128); l1
		 * = l + this.hellRNG.nextInt(16) + 8; (new
		 * WorldGenFlowers(Blocks.brown_mushroom)).generate(this.worldObj,
		 * this.hellRNG, j1, k1, l1); }
		 * 
		 * if (doGen && this.hellRNG.nextInt(1) == 0) { j1 = k +
		 * this.hellRNG.nextInt(16) + 8; k1 = this.hellRNG.nextInt(128); l1
		 * = l + this.hellRNG.nextInt(16) + 8; (new
		 * WorldGenFlowers(Blocks.red_mushroom)).generate(this.worldObj,
		 * this.hellRNG, j1, k1, l1); }
		 */
