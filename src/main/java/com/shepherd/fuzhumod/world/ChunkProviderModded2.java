...
public class ChunkProviderModded2 implements IChunkProvider{
	private Random rand;
...

	{
		...
		villageGenerator = (MapGenVillage) TerrainGen.getModdedMapGen(villageGenerator, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.VILLAGE);
	...
	public ChunkProviderModded2(World par1World, long par2) {
					...
					for (int l2 = 0; l2 < 8; ++l2) {
						...
						for (int i3 = 0; i3 < 4; ++i3) {
							...
							for (int k3 = 0; k3 < 4; ++k3) {
								if ((d15 += d16) > 0.0D) {
									p_147424_3_[j3 += short1] = Blocks.iron_block;
								} else if (k2 * 8 + l2 < b0) {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAKE)) {
