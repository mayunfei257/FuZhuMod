...
//	}
	...
	protected static void addEffect(EntityLivingBase entityLivingBase, int potionID, int duration, int amplifier) {
	...
	protected static boolean teleportUp(EntityLivingBase entityLivingBase, int x, int y, int z, boolean checkBedRock) {
		return teleportUpBase(entityLivingBase, x, y, z, checkBedRock);
	}

	protected static boolean teleportDown(EntityLivingBase entityLivingBase, int x, int y, int z, boolean checkBedRock) {
		return teleportDownBase(entityLivingBase,  x, y, z, checkBedRock);
	}
